...
export default function Home() {
  ...
  return (
    <div className="body-container">
      ...
      <div className='mb-5'>
        <div className="row m-0 row-cols-1 row-cols-md-2">
          ...
          <div className="col py-5 px-5 mt-5 text-center text-md-start text-white">
            ...
            <p className="sub-title-txt mt-3 mb-5 fst-italic">Because AIs Don&apos;t Make Excuses</p>

            <a href='https://cal.com/courtneycarroll/test-callall.ai-phone-appoint'>
      ...
      <div className=' border-top secondary-div border-top outline-header section-width m-auto text-white'>
        ...
        <div className='row m-0 pb-4'>
          ...
          <div className='col'>
            <p>CallAll.AI talking to a client</p>
        ...
        <FadeIn className='fade-in-section '>
          ...
          <div className='row m-0 pb-3 row-cols-1 row-cols-md-3'>
            ...
            <div className='col my-5'>
                ...
                <p className='fs-5 mt-3 text-center secondary-color'>
                  <a href='/pricing' className=''><u>Costs Less than One Deal</u> <i className="bi bi-box-arrow-up-right secondary-color ms-2"></i></a>
                </p>
      ...
      {/* <div className=' border-top outline-header section-width m-auto text-white'>
        ...
        <div className='row m-0 row-cols-1 row-cols-md-2'>
          <div className='col ps-5'>
              <p className='fs-4 my-5 pt-5'>CallAll.AI will automate 15,000+ prospects</p>
